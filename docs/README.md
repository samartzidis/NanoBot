...
**NanoBot** is a Raspberry Pi powered **real-time** AI chat robot ideal for education and **teaching assistance**. It can answer or help clarify challenging questions on a wide range of subjects and serve as a live encyclopedia. 
...
### Fully Local Enterprise-Grade VAD Engine
